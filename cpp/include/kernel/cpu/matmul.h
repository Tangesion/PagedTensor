...
namespace inference_frame::kernel::cpu
{
    ...
    void matmulWeightLaunch(Tensor::SharedPtr out, Tensor::SharedPtr inp, Tensor::SharedPtr weight, Tensor::SharedPtr bias)
    {
    ...
    void matmulWeightThreadPoolLaunch(Tensor::SharedPtr out, Tensor::SharedPtr inp, Tensor::SharedPtr weight, Tensor::SharedPtr bias)
    {
        DataType dataTypeInp = inp->getDataType();
        DataType dataTypeWeight = weight->getDataType();
        DataType dataTypeOut = out->getDataType();
